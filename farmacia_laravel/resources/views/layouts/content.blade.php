...
<body class="bg-blue-200">
    <header class="flex w-full flex-row items-end justify-end bg-white pb-4">
        @auth
            @method('POST')
            <form class="mr-4 mt-2" action="{{ route('logout') }}" method="POST">
                @csrf
                <button
                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        <a class="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                            ...
                            <span
                                class="ms-3 flex-1 whitespace-nowrap">Medicamentos</span>
                            <span
                    ...
                    <li>
                        <a class="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                            ...
                            <span
                                class="ms-3 flex-1 whitespace-nowrap">Inbox</span>
                            <span
                    ...
                    <li>
                        <a class="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                            ...
                            <span
                                class="ms-3 flex-1 whitespace-nowrap">Users</span>
                        </a>
                    </li>
                    <li>
                        <a class="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                            ...
                            <span
                                class="ms-3 flex-1 whitespace-nowrap">Products</span>
                        </a>
                    </li>
                    <li>
                        <a class="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                            ...
                            <span class="ms-3 flex-1 whitespace-nowrap">Sign
                                In</span>
                        </a>
                    </li>
                    <li>
